...
public class BinaryJedisCluster
  ...
  public BinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout,
    ...
    super(new JedisClusterConnectionHandler(jedisClusterNode, poolConfig,
        connectionTimeout, soTimeout, infiniteSoTimeout, user, password, clientName), maxAttempts);
  }
  ...
  public BinaryJedisCluster(Set<HostAndPort> jedisClusterNode, JedisClientConfig clientConfig,
    ...
    super(new JedisClusterConnectionHandler(jedisClusterNode, poolConfig,
        clientConfig), maxAttempts, maxTotalRetriesDuration);
  }
  ...
  public List<byte[]> hmget(final byte[] key, final byte[]... fields) {
    return new JedisClusterCommand<List<byte[]>>() {
      @Override
  ...
  public Set<byte[]> hkeys(final byte[] key) {
    return new JedisClusterCommand<Set<byte[]>>() {
      @Override
  ...
  public Map<byte[], byte[]> hgetAll(final byte[] key) {
    return new JedisClusterCommand<Map<byte[], byte[]>>() {
      @Override
  ...
  public ScanResult<byte[]> scan(final byte[] cursor, final ScanParams params) {
    ...
    return new JedisClusterCommand<ScanResult<byte[]>>() {
      @Override
  ...
  public ScanResult<Map.Entry<byte[], byte[]>> hscan(final byte[] key, final byte[] cursor) {
    return new JedisClusterCommand<ScanResult<Map.Entry<byte[], byte[]>>>() {
      @Override
  ...
  public List<Object> xpending(final byte[] key, final byte[] groupname, final byte[] start,
    ...
    return new JedisClusterCommand<List<Object>>() {
      @Override
