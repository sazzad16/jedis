...
public class JedisCluster extends BinaryJedisCluster implements JedisClusterCommands,
  ...
  public Boolean copy(String srcKey, String dstKey, boolean replace) {
    return new JedisClusterCommand<Boolean>() {
      @Override
  ...
  public String set(final String key, final String value) {
    return new JedisClusterCommand<String>() {
      @Override
  ...
  public byte[] dump(final String key) {
    return new JedisClusterCommand<byte[]>() {
      @Override
  ...
  public Double incrByFloat(final String key, final double increment) {
    return new JedisClusterCommand<Double>() {
      @Override
  ...
  public List<String> hmget(final String key, final String... fields) {
    return new JedisClusterCommand<List<String>>() {
      @Override
  ...
  public Set<String> hkeys(final String key) {
    return new JedisClusterCommand<Set<String>>() {
      @Override
  ...
  public Map<String, String> hgetAll(final String key) {
    return new JedisClusterCommand<Map<String, String>>() {
      @Override
  ...
  public List<Long> lpos(final String key, final String element, final LPosParams params,
      final long count) {
    return new JedisClusterCommand<List<Long>>() {
      @Override
  ...
  public List<Boolean> smismember(final String key, final String... members) {
    return new JedisClusterCommand<List<Boolean>>() {
      @Override
  ...
  public Set<Tuple> zdiffWithScores(String... keys) {
    return new JedisClusterCommand<Set<Tuple>>() {
      @Override
  ...
  public List<Double> zmscore(final String key, final String... members) {
    return new JedisClusterCommand<List<Double>>() {
      @Override
  ...
  public Tuple zpopmax(final String key) {
    return new JedisClusterCommand<Tuple>() {
      @Override
  ...
  public ScanResult<String> scan(final String cursor, final ScanParams params) {
    ...
    return new JedisClusterCommand< ScanResult<String>>() {
      @Override
  ...
  public ScanResult<Tuple> zscan(final String key, final String cursor) {
    return new JedisClusterCommand<ScanResult<Tuple>>() {
      @Override
  ...
  public KeyedListElement blpop(final double timeout, final String... keys) {
    return new JedisClusterCommand<KeyedListElement>() {
      @Override
  ...
  public KeyedZSetElement bzpopmax(double timeout, String... keys) {
    return new JedisClusterCommand<KeyedZSetElement>() {
      @Override
  ...
  public void subscribe(final JedisPubSub jedisPubSub, final String... channels) {
    new JedisClusterCommand<Integer>() {
      @Override
  ...
  public List<GeoCoordinate> geopos(final String key, final String... members) {
    return new JedisClusterCommand<List<GeoCoordinate>>() {
      @Override
  ...
  public List<GeoRadiusResponse> georadius(final String key, final double longitude,
    ...
    return new JedisClusterCommand<List<GeoRadiusResponse>>() {
      @Override
  ...
  public StreamEntryID xadd(final String key, final StreamEntryID id, final Map<String, String> hash) {
    return new JedisClusterCommand<StreamEntryID>() {
      @Override
  ...
  public List<StreamEntry> xrange(final String key, final StreamEntryID start,
    ...
    return new JedisClusterCommand<List<StreamEntry>>() {
      @Override
  ...
  public List<Entry<String, List<StreamEntry>>> xread(final int count, final long block,
    ...
    return new JedisClusterCommand<List<Entry<String, List<StreamEntry>>>>() {
      @Override
  ...
  public StreamPendingSummary xpending(final String key, final String groupname) {
    return new JedisClusterCommand<StreamPendingSummary>() {
      @Override
  ...
  public List<StreamPendingEntry> xpending(final String key, final String groupname,
    ...
    return new JedisClusterCommand<List<StreamPendingEntry>>() {
      @Override
  ...
  public List<StreamEntryID> xclaimJustId(String key, String group, String consumername,
    ...
    return new JedisClusterCommand<List<StreamEntryID>>() {
      @Override
  ...
  public Map.Entry<StreamEntryID, List<StreamEntry>> xautoclaim(final String key, final String group, final String consumerName,
    ...
    return new JedisClusterCommand<Map.Entry<StreamEntryID, List<StreamEntry>>>() {
      @Override
  ...
  public Map.Entry<StreamEntryID, List<StreamEntryID>> xautoclaimJustId(final String key, final String group, final String consumerName,
      final long minIdleTime, final StreamEntryID start, XAutoClaimParams params) {
    return new JedisClusterCommand<Map.Entry<StreamEntryID, List<StreamEntryID>>>() {
      @Override
