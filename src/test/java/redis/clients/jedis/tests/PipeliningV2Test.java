...
public class PipeliningV2Test extends JedisCommandTestBase {
  ...
  public void pipeline() {
    Pipeline p = jedis.beginPipelining();
    p.set("foo", "bar");
    p.get("foo");
  ...
  public void pipelineWithPubSub() {
    Pipeline pipelined = jedis.beginPipelining();
  ...
  public void multiWatch() {
    ...
    Pipeline pipe = jedis.beginPipelining();
  ...
  public void testEvalKeyAndArgWithBinary() {
    ...
    Pipeline bP = jedis.beginPipelining();
  ...
  public void testSyncWithNoCommandQueued() {
    ...
    Pipeline pipeline = jedis2.beginPipelining();
    pipeline.sync();
    ...
    pipeline = jedis2.beginPipelining();
